...
class WebDriver(DriverAPI):
    ...
    def find_link_by_text(self, text):
        return ElementList([WebDriverElement(element) for element in self.driver.find_elements_by_link_text(text)])
    ...
    def find_by_xpath(self, xpath):
        return ElementList([WebDriverElement(element) for element in self.driver.find_elements_by_xpath(xpath)])

    def find_by_name(self, name):
        return ElementList([WebDriverElement(element) for element in self.driver.find_elements_by_name(name)])

    def find_by_id(self, id):
        return ElementList([WebDriverElement(self.driver.find_element_by_id(id))])

    def find_by_tag(self, tag):
        return ElementList([WebDriverElement(element) for element in self.driver.find_elements_by_tag_name(tag)])

...
class BaseWebDriver(DriverAPI):
    ...
    def find_link_by_text(self, text):
        return self.element_class(self.driver.find_element_by_link_text(text))

    def find_by_css_selector(self, css_selector):
        selector = CSSSelector(css_selector)
        return self.element_class(self.driver.find_element_by_xpath(selector.path))

    def find_by_xpath(self, xpath):
        return self.element_class(self.driver.find_element_by_xpath(xpath))

    def find_by_name(self, name):
        return self.element_class(self.driver.find_element_by_name(name))

    def find_by_id(self, id):
        return self.element_class(self.driver.find_element_by_id(id))

    def find_by_tag(self, tag):
        return self.element_class(self.driver.find_element_by_tag_name(tag))

...
from selenium.webdriver import Remote, FirefoxProfile
...
class WebDriver(BaseWebDriver):
    ...
    def __init__(self, url=DEFAULT_URL, browser='firefox', user_agent=None,
                 wait_time=2, **ability_args):
        ...
        self.driver = Remote(url, abilities, browser_profile=profile)

...
class IsElementVisibleTest:
    ...
    def test_is_element_visible_by_css_using_a_custom_wait_time(self):
        ...
        self.browser.find_by_css(".show-invisible-element").click()
        self.assertTrue(
            self.browser.is_element_visible_by_css("#invisible", wait_time=3)
        )
    ...
    def test_is_element_not_visible_by_css_using_a_custom_wait_time(self):
        ...
        self.assertTrue(
            self.browser.is_element_not_visible_by_css("#invisible", wait_time=3)
        )
    ...
    def test_is_element_visible_by_xpath(self):
        ...
        self.browser.find_by_css(".show-invisible-element").click()
        self.assertTrue(
            self.browser.is_element_visible_by_xpath('//div[@id="invisible"]')
        )
    ...
    def test_is_element_not_visible_by_xpath(self):
        ...
        self.assertTrue(
            self.browser.is_element_not_visible_by_xpath('//div[@id="invisible"]')
        )

...
class IsElementVisibleTest(object):
    ...
    def test_is_element_visible_by_css(self):
        ...
        self.browser.reload()
        self.browser.find_by_css('.make-p-visible').click()
        self.assertTrue(self.browser.is_element_visible_by_css('#disappearing-element'))
    ...
    def test_is_element_visible_by_css_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        self.browser.find_by_css('.make-p-visible').click()
        self.assertTrue(self.browser.is_element_visible_by_css('#disappearing-element', wait_time=3))
    ...
    def test_is_element_visible_by_css_returns_false_if_element_is_not_visible(self):
        ...
        self.browser.reload()
        self.assertFalse(self.browser.is_element_visible_by_css('#disappearing-element'))

    def test_is_element_not_visible_by_css(self):
        "should is element not visible by css verify if element is not visible"
        self.browser.reload()
        self.assertTrue(self.browser.is_element_not_visible_by_css('#disappearing-element'))
    ...
    def test_is_element_not_visible_by_css_returns_false_if_element_is_visible(self):
        ...
        self.browser.reload()
        self.assertFalse(self.browser.is_element_not_visible_by_css('#disappearing-element'))
    ...
    def test_is_element_not_visible_by_css_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        self.assertTrue(self.browser.is_element_not_visible_by_css('#disappearing-element', wait_time=3))

    def test_is_element_visible_by_xpath(self):
        "should is element visible by xpath verify if element is visible"
        self.browser.reload()
        self.browser.find_by_css('.make-p-visible').click()
        self.assertTrue(self.browser.is_element_visible_by_xpath('//p[@id="disappearing-element"]'))
    ...
    def test_is_element_visible_by_xpath_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        self.browser.find_by_css('.make-p-visible').click()
        self.assertTrue(self.browser.is_element_visible_by_xpath('//p[@id="disappearing-element"]', wait_time=3))
    ...
    def test_is_element_visible_by_xpath_returns_false_if_element_is_not_visible(self):
        ...
        self.browser.reload()
        self.assertFalse(self.browser.is_element_visible_by_xpath('//p[@id="disappearing-element"]'))

    def test_is_element_not_visible_by_xpath(self):
        "should is element not visible by xpath verify if element is not visible"
        self.browser.reload()
        self.assertTrue(self.browser.is_element_not_visible_by_xpath('//p[@id="disappearing-element"]'))
    ...
    def test_is_element_not_visible_by_xpath_returns_false_if_element_is_visible(self):
        ...
        self.browser.reload()
        self.browser.find_by_css('.make-p-visible').click()
        self.assertFalse(self.browser.is_element_not_visible_by_xpath('//p[@id="disappearing-element"]'))
    ...
    def test_is_element_not_visible_by_xpath_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        self.assertTrue(self.browser.is_element_not_visible_by_xpath('//p[@id="disappearing-element"]', wait_time=3))

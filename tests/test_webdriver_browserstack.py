...
from splinter.driver.webdriver.browserstack import config_browserstack
from splinter import Browser
from .fake_webapp import EXAMPLE_APP
from .base import WebDriverTests


class BrowserstackBrowserTest(WebDriverTests, unittest.TestCase):
    credential = {'username': 'browserstackuser', 'password': 'browserstackpassword'}
    params = None

    @classmethod
    def setUpClass(cls):
        abilities = config_browserstack('Windows', 'xp', 'IE', '7.0', debug=True, local=True)
        cls.params = abilities
        cls.params.update(cls.credential)
        cls.browser = Browser('browserstack', **cls.params)
    ...
    def test_support_with_statement(self):
        ...
        with Browser('browserstack', **self.params) as remote:
            pass

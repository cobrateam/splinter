...
class IsElementPresentTest(object):
    ...
    def test_is_element_present_by_tag_using_a_custom_wait_time(self):
        ...
        self.browser.driver.refresh()
        self.browser.find_by_css_selector('.add-async-element').first.click()
        self.browser.is_element_present_by_tag('h5', wait_time=3) | should | be(True)
    ...
    def test_is_element_present_by_name_using_a_custom_wait_time(self):
        ...
        self.browser.driver.refresh()
        self.browser.find_by_css_selector('.add-async-element').first.click()
        self.browser.is_element_present_by_name('async-input2', wait_time=3) | should | be(True)
    ...
    def test_is_element_not_present_by_name_using_a_custom_wait_time(self):
        ...
        self.browser.is_element_present_by_name('async-input2', wait_time=3) | should | be(True)
        self.browser.find_by_css_selector('.remove-async-element').first.click()
        self.browser.is_element_not_present_by_name('async-input2', wait_time=3) | should | be(True)

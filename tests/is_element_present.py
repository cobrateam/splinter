...
class IsElementPresentTest(object):
    ...
    def test_is_element_not_present_by_xpath_returns_false_if_element_is_present(self):
        ...
        self.browser.reload()
        self.browser.find_by_css('.add-async-element').first.click()
        assert_false(self.browser.is_element_not_present_by_xpath('//h4'))
    ...
    def test_is_element_not_present_by_xpath_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        assert_true(self.browser.is_element_not_present_by_xpath('//h4', wait_time=3))
    ...
    def test_is_element_present_by_tag_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        self.browser.find_by_css('.add-async-element').first.click()
        assert_true(self.browser.is_element_present_by_tag('h4', wait_time=3))
    ...
    def test_is_element_not_present_by_tag_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        assert_true(self.browser.is_element_not_present_by_tag('h4', wait_time=3))
    ...
    def test_is_element_not_present_by_value_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        assert_true(self.browser.is_element_not_present_by_value('async-header-value', wait_time=3))
    ...
    def test_is_element_present_by_id_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        self.browser.find_by_css('.add-async-element').first.click()
        assert_true(self.browser.is_element_present_by_id('async-header', wait_time=3))
    ...
    def test_is_element_present_by_id_returns_false_if_element_is_not_present(self):
        ...
        self.browser.reload()
        assert_false(self.browser.is_element_present_by_id('async-header'))
    ...
    def test_is_element_not_present_by_id_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        assert_true(self.browser.is_element_not_present_by_id('async-header', wait_time=3))
    ...
    def test_is_element_not_present_by_id_returns_false_if_element_is_present(self):
        ...
        self.browser.reload()
        self.browser.find_by_css('.add-async-element').first.click()
        assert_false(self.browser.is_element_not_present_by_id('async-header'))
    ...
    def test_is_element_present_by_name_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        self.browser.find_by_css('.add-async-element').first.click()
        assert_true(self.browser.is_element_present_by_name('async-input', wait_time=3))
    ...
    def test_is_element_not_present_by_name_using_a_custom_wait_time(self):
        ...
        self.browser.reload()
        assert_true(self.browser.is_element_not_present_by_name('async-input', wait_time=3))
    ...
    def test_is_element_not_present_by_name_returns_false_if_element_is_present(self):
        ...
        self.browser.reload()
        self.browser.find_by_css('.add-async-element').first.click()
        assert_false(self.browser.is_element_not_present_by_name('async-input'))
